...
export default function Compare() {
  const comparisonData: ComparisonRow[] = [
    ...
    },
    {
      ...
      paper: <X className="text-red-500 w-5 h-5 mx-auto" />,
      basic: <span className="text-amber-500 text-base font-semibold uppercase tracking-wider block text-center">Limited</span>,
      vbiz: <Check className="text-green-500 w-5 h-5 mx-auto" />,
    },
    {
      ...
      paper: <X className="text-red-500 w-5 h-5 mx-auto" />,
      basic: <span className="text-amber-500 text-base font-semibold uppercase tracking-wider block text-center">Sometimes</span>,
      vbiz: <Check className="text-green-500 w-5 h-5 mx-auto" />,
    },
    {
      ...
      paper: <X className="text-red-500 w-5 h-5 mx-auto" />,
      basic: <span className="text-neutral-500 text-base uppercase font-bold text-center block">Rare</span>,
      vbiz: <Check className="text-green-500 w-5 h-5 mx-auto" />,
    },
    {
      feature: 'First Impression Energy',
      description: 'The psychological impact and confidence when meeting a prospective lead',
      paper: <span className="text-red-400 text-base text-center block">Weak</span>,
      basic: <span className="text-red-400 text-base text-center block">Weak</span>,
      vbiz: <span className="text-brand-gold font-bold text-base text-center block">Exceptional</span>,
      important: true,
    },
    {
      ...
      paper: <X className="text-red-500 w-5 h-5 mx-auto" />,
      basic: <span className="text-amber-500 text-base font-semibold uppercase tracking-wider block text-center">Somewhat</span>,
      vbiz: <Check className="text-green-500 w-5 h-5 mx-auto" />,
      important: true,
    },
  ];
            ...
            >
              <div className="overflow-x-auto border border-emerald-500/10 bg-brand-surface/60 backdrop-blur-md rounded-3xl py-6 px-4 md:py-8 md:px-6 text-left">
                <table className="w-full text-left border-collapse min-w-[700px]">
                  <thead>
                    <tr className="border-b border-white/5 text-neutral-400 text-base uppercase tracking-wider">
                    ...
                    {comparisonData.map((row, index) => (
                      ...
                      >
                        <td className="py-6 px-4 text-left">
                          <span className="text-white block font-semibold text-base md:text-lg">
                            {row.feature}
                            {row.important && (
                              <span className="ml-2 inline-block text-sm md:text-base uppercase bg-brand-gold/20 text-brand-gold px-1.5 py-0.5 rounded font-bold tracking-wider">
                                Critical
                              </span>
                            )}
                          </span>
                          <span className="text-neutral-400 text-base font-light mt-0.5 block line-clamp-2">
                            {row.description}
                          </span>
                        </td>
          ...
          <SectionRevealRoot viewport="compareBelow" simultaneous={false} replayOnNavigate>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
              ...
              <div className="bg-gradient-to-br from-brand-elevated to-brand-dark py-6 px-4 md:py-8 md:px-6 rounded-3xl border border-white/5 relative overflow-hidden h-full flex flex-col justify-between text-left">
                ...
                <div>
                  <span className="text-base font-bold text-brand-gold uppercase tracking-widest block mb-1">Our Hidden Strength</span>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-orange-500/10 text-orange-400 flex items-center justify-center font-bold text-base border border-orange-500/20 shrink-0">
                        01
                      </div>
                    ...
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-cyan-500/10 text-cyan-400 flex items-center justify-center font-bold text-base border border-cyan-500/20 shrink-0">
                        02
                      </div>
                      <div className="text-left">
                    ...
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-base border border-purple-500/20 shrink-0">
                        03
                      </div>
                      <div className="text-left">
                    ...
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-emerald-500/10 text-emerald-400 flex items-center justify-center font-bold text-base border border-emerald-500/20 shrink-0">
                        04
                      </div>
                      <div className="text-left">
            ...
            <ScrollRevealCard direction="right" distance="LG" delay={0.1} className="h-full">
              <div className="bg-neutral-900/40 border border-white/5 py-6 px-4 md:py-8 md:px-6 rounded-3xl relative flex flex-col justify-between h-full text-left min-h-[300px]">
                ...
                <div className="mt-8 border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-left">
                  ...
                  <MagneticButton
                    href="/pricing"
                    className="px-6 py-2.5 rounded-full bg-brand-gold text-black text-base font-bold tracking-wide hover:bg-white h-10 w-44 flex items-center justify-center"
                  >
                    Check Packages
                  </MagneticButton>
                </div>
