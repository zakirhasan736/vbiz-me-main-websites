/** SSR ambient orbs — present on first paint so they do not create CLS. */
export function HeroAmbientLazy() {
  return (
    <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
      ...
      <div className="hero-orb-blue absolute bottom-1/4 left-5 w-[400px] h-[400px] bg-emerald-500/12 blur-[100px] rounded-full" />
      <div className="hero-orb-blue absolute top-1/3 right-0 w-[320px] h-[320px] bg-emerald-400/8 blur-[90px] rounded-full" />
